const META_TITLE = 'Gia Dụng Mới | Cửa Hàng Đồ Gia Dụng Chất Lượng, Giá Tốt';
export const META_DESCRIPTION =
  'Gia Dụng Mới chuyên cung cấp đồ gia dụng thông minh, hiện đại với giá cả hợp lý. Cam kết sản phẩm chính hãng, giao hàng toàn quốc, đổi trả linh hoạt.';
